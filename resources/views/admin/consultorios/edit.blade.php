...
@section('content')
    <div class="row">
        <h1>Actualizacion de datos del Consultorio</h1>
    </div>
    ...
    <div class="col-md-12">
            <div class="card card-outline card-primary">
              <div class="card-header">
                <h3 class="card-title">Actualice los Datos del Consultorio</h3>
                  ...
                  <div class="row">
                        ...
                        <div class="col-md-3">
                          <div class="form group">
                              ...
                              <input type="number" name="telefono" value ="{{$consultorio->telefono}}" class="form-control" >
                        ...
                        <div class="col-md-3">
                          <div class="form group">
                              ...
                              <select name="estado" class="form-control" id="">
                                  <option value="ACTIVO" @selected($consultorio->estado)> ACTIVO</option>
                                  <option value="INACTIVO" @selected($consultorio->estado)>INACTIVO</option>
                              </select>
                          </div>
                        </div>
                        ...
                        <div class="col-md-12">
                          <div class="form group">
                            <a href="{{url('admin/consultorios')}}" class="btn btn-secondary">cancelar</a>
                              <button type="submit" class="btn btn-info">Actualizar Consultorio</button>
                          </div>
                        </div>
                      </div>
