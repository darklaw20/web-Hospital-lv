                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                            ...
                            <div class="form group">
                                ...
                                <input type="text" name="curp"  value ="{{$secretaria->curp}}" class="form-control" required>
                                @error('curp')
                                <small style="color:red">{{$message}}</small>
                                @enderror
                            </div>
                            ...
                            <div class="form group">
                                ...
                                <input type="number" name="telefono" value ="{{$secretaria->telefono}}" class="form-control" required>
                                @error('curp')
                                <small style="color:red">{{$message}}</small>
                                @enderror
                            </div>
